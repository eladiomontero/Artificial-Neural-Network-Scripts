...
n_tr = 7000;             % Number of training points (this includes training and validation).
n_te = 3000;             % Number of test points
n_neurons = 50;         % Number of neurons
n = 10000;               % Total number of samples
ne = 10000;               % Number of epochs
perc_training = 0.8;    % Number between 0 and 1. The validation set will be 1-perc_training.
